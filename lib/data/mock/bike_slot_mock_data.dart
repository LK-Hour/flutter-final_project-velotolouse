...
const List<BikeSlot> mockCapitoleSlots = <BikeSlot>[
  ...
  BikeSlot(id: 'CO-02', status: BikeSlotStatus.unavailable),
  BikeSlot(id: 'CO-03', status: BikeSlotStatus.unavailable),
  BikeSlot(id: 'CO-04', status: BikeSlotStatus.available, bikeCode: 'CO-07'),
  BikeSlot(id: 'CO-05', status: BikeSlotStatus.unavailable),
  BikeSlot(id: 'CO-06', status: BikeSlotStatus.unavailable),
  BikeSlot(id: 'CO-07', status: BikeSlotStatus.available, bikeCode: 'CO-11'),
  BikeSlot(id: 'CO-08', status: BikeSlotStatus.unavailable),
  BikeSlot(id: 'CO-09', status: BikeSlotStatus.unavailable),
  BikeSlot(id: 'CO-10', status: BikeSlotStatus.unavailable),
];
